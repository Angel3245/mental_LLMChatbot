...
if __name__ == "__main__":
    ...
    if args.option == "model_training":
        # python app\question_answering.py -o model_training -d MentalKnowledge -m GPT-2 -e 2 -b 32 -lr 3e-05 -neg simple -loss softmax
    ...
    if args.option == "get_finetune_results":
        # python app\question_answering.py -o get_finetune_results -d MentalKnowledge -m GPT-2
        batch_sizes = [16, 32]
